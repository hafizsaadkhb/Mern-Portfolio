      ...
      <div className="grid grid-cols-4 gap-5 sm:grid-cols-1 md:grid-cols-3">
        {projects.map((project) => (
          <div className="shadow-lg border p-5 border-gray-400 shadow-gray-400">
            ...
            />
            <div className="flex flex-row gap-1 overflow-x-scroll my-2">
              {project.technologies.length !== 0 &&
                project.technologies.map((tech) => (
                  <h1 className="border border-tertiary text-tertiary px-3 py-1">
                    {tech}
                  </h1>
                ))}
            </div>
            ...
            <h1 className="overflow-scroll whitespace-nowrap">
              {project.link}
            </h1>
            <h1>
              <br />
        ...
        >
          {(selectedItemForEdit || type === "add") && (
            ...
            >
              ...
              <Form.Item name="link" title="Project URL" label="Project URL">
                <Input type="text"></Input>
              </Form.Item>
